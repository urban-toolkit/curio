...
| 15 | [Vega-Lite spec forms and catalogs](examples/15-vega-lite-spec-forms-and-catalogs.md) | Writing the shape encoding and projection yourself, across layered and side-by-side maps, over geojson, GeoParquet and a spatial join | Chicago green roofs and sidewalk labels | 🟡 |
