...
height histogram. OSM parsing happens entirely in the browser via DuckDB-WASM, with no Overpass call at run
time.
...
A single WebGPU map of Lower Manhattan: the full OSM layer stack of surface, parks, water, roads, and
