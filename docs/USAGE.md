...
Curio requires **Python 3.11 or 3.12**. It has been tested on Windows 11, macOS Sonoma 14.5, and Ubuntu. It is recommended to install the environment using [Anaconda](https://anaconda.org):

```bash
conda create -n curio python=3.11   # or python=3.12
...
conda install -c conda-forge nodejs=25
```
