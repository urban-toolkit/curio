...
export class PythonInterpreter {
    ...
    public interpretCode(unresolvedUserCode: string, userCode: string, input: string, callback: any, boxType: BoxType, nodeId: string, workflow_name: string, boxExecProv: any){
