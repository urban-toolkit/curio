...
|-------|--------|---------------|-----------------|------------------|
| [https://www.faa.gov/air_traffic/publications/atpubs/aim_html/chap7_section_1.html] | [Weather] | [How the FAA determines dangerous conditions for transportation] | [Flying vs Driving] | [It's a system relying on pilot calling the reroute] |
| [https://www.faa.gov/sites/faa.gov/files/15_phak_ch13.pdf] | [Weather] | [How the FAA determines dangerous conditions for transportation] | [Flying vs Driving] | [It's a system relying on pilot calling the reroute] |
| [https://bravo6flightacademy.com/mastering-the-skies-the-role-of-weather-in-pilot-training-safety/] | [Weather] | [How the FAA determines dangerous conditions for transportation] | [Flying vs Driving] | [It's a system relying on pilot calling the reroute] |
| [https://ops.fhwa.dot.gov/weather/roadimpact.htm] | [Weather] | [Dangers from weather while driving] | [Dosent predict weather, only collects and shows past data] | [Bad weather usually is dangerous to drive in] |
| [https://aerisiq.climate-dpi.org/] | [Weather] | [Shows weather on planned route] | [Dosent show future weather on the route] | [Its a complex system] |

## Next Steps

### Immediate Actions:
- [ ] [Action 1 - Explore data to find a good strech of road]
- [ ] [Action 2 - Explore how to use OSMnx]
- [ ] [Action 3 - calculate route between 2 different points]
