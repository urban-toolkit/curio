...
- **Technology:** A free tier Map Box licence will be required, (TBD, still compiling all necessary technologies)
- **Participants:** [Number and type of users needed for research activities] (TDB)
...
### Technical Constraints:
  ...
  2. This project wont be uploaded to a cloud provider
