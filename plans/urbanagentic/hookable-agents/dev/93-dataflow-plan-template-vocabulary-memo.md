...
**All five defects are now closed.** Remaining: commit 7 (docs) — and the two follow-ups this work surfaced: readers taking the seed lock to close the swap's rename gap (A1 — **closed by [`dev/99`](99-package-seed-reader-locking-memo.md), IMPLEMENTED 2026-08-24, `BL-P5-20260824-42`**), and the Package Builder's delegate runs being blind to the existing roster (closed by `dev/94`, `DEC-063`).
