...
For detailed instructions on how to use the project, please check [docs/USAGE.md]. If you'd like to contribute, check [docs/CONTRIBUTIONS.md] for guidelines. For questions, join [UTK's Discord](https://discord.gg/vjpSMSJR8r) server.
