...
/** Abstract geo preview polygon — subtle illustration in the drawer */
...
function BrowseCard({
  ...
  // Last tag gets the accent color for this format
    ...
    <div className={styles.page}>
      ...
      <main className={styles.browseMain}>
        ...
        <div className={styles.filterBar}>
          ...
          {/* Grid / list toggle (decorative, matches SVG) */}
