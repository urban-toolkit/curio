...
describe("requiresAgents helpers (dev/106)", () => {
  ...
  it("a leaf card installs plainly", () => {
    ...
    expect(installLabel(card())).toBe("Add to project");
