"""Normalised pack release channel (warehouse / catalog).

Kept separate from :mod:`utk_curio.backend.app.packs.manifest` helpers that
need :class:`PackManifest` to avoid import cycles with :mod:`catalog_family`.
"""
