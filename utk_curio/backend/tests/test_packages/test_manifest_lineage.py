"""Tests for optional package manifest ``lineage`` (fork provenance)."""
...
def test_forked_from_and_distinct_root(tmp_path: Path) -> None:
    d = _write_packageage_dir(
        ...
        1,
        lineage={
            "forkedFrom": {"packageId": "curio.palette.fork.abc", "major": 1},
...
@pytest.mark.parametrize(
    ...
    [
        [],
        {"forkedFrom": {"packageId": "ai.upstream.parent", "major": "1"}},
        {"forkedFrom": {"packageId": "BAD_ID", "major": 1}},
        {"root": {"packageId": "ai.upstream.parent", "major": 1}},
    ],
)
