"""Unit tests for :mod:`utk_curio.backend.app.packs.catalog_family`."""
...
def test_family_key_for_manifest_fork_and_singleton():
    from utk_curio.backend.app.packs.manifest import PackLineage, PackLineageCoord, PackManifest
    ...
    fork = PackManifest(
        ...
        license=None,
        lineage=PackLineage(
            forked_from=PackLineageCoord("parent", 1),
            root=PackLineageCoord("rootfam", 1),
        ),
    )
